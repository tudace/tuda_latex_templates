%% This is file `DEMO-TUDaPub-de.tex' version 4.06 (2026-06-08),
%% it is part of
...
% Spracheinstellungen
%%%%%%%%%%%%%%%%%%%
\usepackage[english,main=ngerman]{babel}% English wird geladen, um eine Englische Zusammenfassung zu ermöglichen
