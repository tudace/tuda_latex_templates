...
Die Option \code{custommargins} beziehungsweise \code{custommargins=true} aktiviert die automatische Größenberechnung durch das in KOMA integrierte \code{typearea}.
...
Die Option \code{custommargins} verfügt ab Version 1.10 auch über den Wert \code{geometry}, welcher über das Setzen von \code{custommargins=geometry} in den Klassenoptionen eingestellt wird. Damit können die Ränder auch durch einen Aufruf von \code{\textbackslash{}geometry} vor Beginn des Dokuments manuell angepasst werden.
