...
\minisec{Logo}
Das Fachbereichslogo wird über die Option \verb+departmentlogofile=tuda_maschinenbau_logo+ übergeben. Falls die Datei fehlt, kann über diesen Weg eine alternative Datei übergeben werden. Falls der Wert leer bleibt, wird kein Bild eingefügt.
...
\begin{verbatim}
\colorlet{TUDaPrimary1}{TUDa-6b}
\colorlet{TUDaPrimary2}{TUDa-2d}
\colorlet{TUDaSecondary1}{TUDa-9a}
\colorlet{TUDaSecondary2}{TUDa-8a}
\colorlet{TUDaSecondary3}{TUDa-6a}
\colorlet{TUDaSecondary4}{TUDa-3a}
\colorlet{TUDaSecondary5}{TUDa-4a}
\colorlet{TUDaSecondary6}{TUDa-5a}
\colorlet{TUDaArrow}{TUDaPrimary2}
\end{verbatim}
