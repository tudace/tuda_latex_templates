...
\minisec{Logo}
Das Fachbereichslogo wird über die Option \verb+departmentlogo=tuda_maschinenbau_logo+ übergeben. Falls die Datei fehlt, kann über diesen Weg eine alternative Datei übergeben werden. Falls der Wert leer bleibt, wird kein Bild eingefügt.
