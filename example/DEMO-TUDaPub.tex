...
\begin{abstract}
	Dieses Dokument stellt ein Template und gleichzeitig die Verwendungsdokumentation zur Dokumentenklasse tudapub, einem Teil des \TUDaTeX-Paketes dar.
...
\cls{tudapub} kann entgegen der Corpodate Design Richtlinien auch andere Schriftgrößen verarbeiten. Hierfür wird die \code{fontsize}-Option aus \KOMAScript{} genutzt (z.\,B. \code{fontsize=11pt}). Sofern keine spezielle Schriftgrößendatei für \TUDaTeX{} vorliegt, wird die mit \KOMAScript{} ausgelieferte Datei gewählt.
