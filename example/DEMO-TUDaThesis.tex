...
\begin{description}\setkomafont{descriptionlabel}{\ttfamily\textbackslash}
	...
	Dieses Makro verfügt jedoch zusätzlich über die Möglichkeit Abweichende Einträge gegenüber den Vorgaben anzugeben. Insbesondere wenn eine gesonderte Formulierung gegenüber der voreingestellten \enquote{im Fachbereich} und ihren Varianten notwendig ist. Hierfür liefert \code{\tbs{}department} ein optionales Argument:
