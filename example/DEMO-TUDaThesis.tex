...
\begin{description}\setkomafont{descriptionlabel}{\ttfamily\textbackslash}
	...
	\item[titlegraphic] Hier kann Code übergeben werden, der den farbigen Block im unteren Teil der Titelseite ersetzt. Als Maße können hier die Längen \verb+\width+ und \verb+\height+ verwendet werden. Sie passen sich dem Verfügbaren Platz an. Für ein Beispiel und weitere Möglichkeiten, wie automatischen Beschnitt, sei auf die TUDaPub-Dokumentation verwiesen.
